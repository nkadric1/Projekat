...
public class EmployeeManagerTest {
    ...
    void validName() throws EmployeeException {
      ...
      EmployeeException exc= assertThrows(EmployeeException.class, () -> {
   ...
   EmployeeException emp= assertThrows(EmployeeException.class,()->{employeeManager.add(e);},"ID is autogenerated. Cannot add department.");
   Assertions.assertEquals("ID is autogenerated. Cannot add department.", emp.getMessage());
        ...
        @Test
    void testAddNewEmp() throws EmployeeException{
        ...
        @Test
    void testUpdateEmp() throws  EmployeeException{
